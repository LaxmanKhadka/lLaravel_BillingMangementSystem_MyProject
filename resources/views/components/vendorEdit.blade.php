    ...
    <div class="row">
        <div class="col-md-10">
            <div class="card">
                ...
                <form class="form-horizontal" method="post" action="#" id="vendorEdit">

                    @csrf
                    <input type="hidden" value="{{ $v->id }}" name="id" id="id">
                    <div class="card-body">
                        <div class="editVendor" style="display:block">
