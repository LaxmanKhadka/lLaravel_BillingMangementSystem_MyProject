                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Start date: activate to sort column ascending"
                                                        style="width: 24.0781px;font-weight:bold;"> City </th>
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Start date: activate to sort column ascending"
                                                        style="width: 24.0781px;font-weight:bold;"> Country </th>
                                                    <th class="sorting" tabindex="0" aria-controls="zero_config"
                                                        rowspan="1" colspan="1"
                                                        ...
                                                        <td>
                                                            <div style=" float:right">
                                                                <button type="button" data-id="{{ $v->id }}"
                                                                    ...
                                                                    class="btn btn-success btn-sm text-white customerEdit">
                                                                    Edit
                                                                </button>
                                                                ...
                                                                <button type="button"data-id="{{ $v->id }}"
                                                                    ...
                                                                    class="btn btn-danger btn-sm text-white customerDelete">
                                                                    Delete
                                                                </button>
                                                            </div>
                                                        </td>
