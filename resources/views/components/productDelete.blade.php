    ...
    <div class="row">
        <div class="col-md-10">
            <div class="card">
                ...
                <div id="result"></div>
                <form class="form-horizontal" method="post" action="#" id="productDelete">
                    @csrf

                    <input type="hidden" value="{{ $p->id }}" name="id" id="id">
                    <div class="card-body">

                        <div class="productDelete" style="display:block">
                            ...
                            <div class="border-top">
                                <div class="card-body" style="float:right">
                                    <button type="button" id="deleteProduct" name="button"
...
<script>
    ...
    $("#deleteProduct").on("click", function() {
        ...
        var data = $("#productDelete").serialize();
